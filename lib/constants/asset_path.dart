...
final String imageResultSection = _getImagePath("result.png");
final String imageRoutineSection = _getImagePath("routine.png");
...
final String iconWarning = _getImagePath("warning.png");
final String iconFacebook = _getImagePath("facebook.png");
